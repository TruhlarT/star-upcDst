...
query = [
    ...
    #"production=P20a,trgsetupname=pp500_production_2017,filetype=daq_reco_MuDst,filename~st_W,storage="
    "production=P18ih,trgsetupname=pp500_production_2017,filetype=daq_reco_MuDst,filename~st_rp,storage="
    #"production=P18ih,trgsetupname=pp500_production_rhicf_2017,filetype=daq_reco_MuDst,filename~st_rp,storage="
]
